...
const navItems: Record<string, { label: string; href: string; icon: React.ElementType }[]> = {
  ...
  secretariat: [
    ...
    { label: 'National Rankings', href: '/secretariat/rankings/national', icon: Trophy },
    { label: 'Regional Rankings', href: '/secretariat/rankings/regional', icon: Trophy },
    { label: 'Continental Rankings', href: '/secretariat/rankings/continental', icon: Trophy },
    { label: 'Global Rankings', href: '/secretariat/rankings/global', icon: Trophy },
  ...
  super_admin: [
    ...
    { label: 'All Submissions', href: '/admin/submissions', icon: FileText },
    { label: 'Judge Applications', href: '/admin/judge-applications', icon: Gavel },
    { label: 'Submission Approvals', href: '/admin/approvals', icon: CheckSquare },
    { label: 'Judge Assignments', href: '/secretariat/panels', icon: Layers },
    { label: 'Routing Engine', href: '/secretariat/routing', icon: GitBranch },
    { label: 'Judges', href: '/secretariat/judges', icon: Users },
    { label: 'Judge Work Rate', href: '/secretariat/judge-work-rate', icon: Activity },
    { label: 'Scores', href: '/admin/scores', icon: Award },
    { label: 'National Rankings', href: '/admin/rankings/national', icon: Trophy },
    { label: 'Regional Rankings', href: '/admin/rankings/regional', icon: Trophy },
    { label: 'Continental Rankings', href: '/admin/rankings/continental', icon: Trophy },
    { label: 'Global Rankings', href: '/admin/rankings/global', icon: Trophy },
    { label: 'All Applicants (A-Z)', href: '/secretariat/statistics', icon: CheckSquare },
    { label: 'Manage Users', href: '/secretariat/users', icon: Settings },
    { label: 'Finance', href: '/admin/finance', icon: DollarSign },
    { label: 'Messaging', href: '/admin/messaging', icon: MessageSquare },
    { label: 'Profile', href: '/profile', icon: User },
