...
export const MagicLinkEmail = ({ siteName, confirmationUrl }: MagicLinkEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your login link for the TEGA Awards Portal</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} alt="TEGA Awards" width="140" height="auto" style={{ marginBottom: '24px' }} />
        <Heading style={h1}>Your Login Link</Heading>
        <Text style={text}>Click the button below to log in to the TEGA Awards Portal. This link will expire shortly.</Text>
