...
export const RecoveryEmail = ({ siteName, confirmationUrl }: RecoveryEmailProps) => (
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Reset your TEGA Awards Portal password</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO_URL} alt="TEGA Awards" width="140" height="auto" style={{ marginBottom: '24px' }} />
        <Heading style={h1}>Reset Your Password</Heading>
        <Text style={text}>We received a request to reset your password for the TEGA Awards Portal. Click the button below to choose a new password.</Text>
